...
Build Windows portable zip and NSIS installer packages (**64-bit Windows / `windows/amd64` only**; no 32-bit or ARM64 release yet):
...
The NSIS installer shows a requirements page stating that **64-bit Windows (x64)** is required.
Required host tools:
