...
**Dahusim** — форк Android-клиента [husi](https://codeberg.org/xchacha20-poly1305/husi) с упором на работу "из коробки" в сложных сетевых условиях: простой режим, автовыбор серверов и готовые пресеты маршрутизации.
...
- **Что:** клиент на базе sing-box с готовыми профилями маршрутизации.
