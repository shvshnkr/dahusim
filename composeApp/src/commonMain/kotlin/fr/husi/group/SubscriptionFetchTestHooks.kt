...
object SubscriptionFetchTestHooks {
    ...
    /** Per-fetch-link HTTP timeout (ms) recorded by [fr.husi.group.SubscriptionHttpFetch] while [enabled]. */
    val lastTimeoutMsByLink = mutableMapOf<String, Int>()
